...
export const CometChatTabs = (props: {
  ...
  const tabItems = [
    {
      ...
      icon: '/icons/comet-chat/assets/chats.svg',
    },
    {
      id: 'calls',
      name: getLocalizedString('call_logs_title'),
      icon: '/icons/comet-chat/assets/calls.svg',
    },
    {
      id: 'users',
      name: getLocalizedString('user_title'),
      icon: '/icons/comet-chat/assets/users.svg',
    },
  ...
  return (
    ...
    >
      {tabItems
        .filter(
          (tabItem) => layoutFeatures?.tabs?.includes(tabItem.id)
        )
        .map((tabItem) => (
