      ...
      >
        <rect
          ...
          className={cn(
            ...
            // focus
            'group-focus/checkbox:fill-[#EF4F54]',
            // disabled
            'group-disabled/checkbox:fill-bg-soft-200',
            // hover
            'group-hover/checkbox:group-data-[state=checked]/checkbox:fill-[#d94349]',
            'group-hover/checkbox:group-data-[state=indeterminate]/checkbox:fill-[#d94349]',
            // focus
            'group-focus/checkbox:group-data-[state=checked]/checkbox:fill-[#d94349]',
            'group-focus/checkbox:group-data-[state=indeterminate]/checkbox:fill-[#d94349]',
            // checked
            'group-data-[state=checked]/checkbox:fill-[#EF4F54]',
            'group-data-[state=indeterminate]/checkbox:fill-[#EF4F54]',
            // disabled checked
