        ...
        >
          <circle
            ...
            className={cn(
              ...
              // checked
              'group-data-[state=checked]/radio:stroke-[#EF4F54]',
              // hover checked
              'group-hover/radio:group-data-[state=checked]/radio:stroke-[#d94349]',
              // focus checked
              'group-focus/radio:group-data-[state=checked]/radio:stroke-[#d94349]',
              // disabled
